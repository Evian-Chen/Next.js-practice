...
const MONGODB_URI_CHATGPT = process.env.MONGODB_URI_CHATGPT;

if (!MONGODB_URI_CHATGPT) {
    throw new Error("Please define the MONGODB_URI_CHATGPT environment variable in .env");
}
...
export async function connectDB() {
    ...
    try {
        await mongoose.connect(MONGODB_URI_CHATGPT);
